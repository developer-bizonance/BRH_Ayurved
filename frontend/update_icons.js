...
const newSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 72" width="40" height="40">
  <path fill="#f5f5f5" stroke="#ff2a2a" strokeWidth="3" strokeLinejoin="round" d="M8,4 h26 l14,14 v46 a4,4 0 0,1 -4,4 H8 a4,4 0 0,1 -4,-4 V8 a4,4 0 0,1 4,-4 z" />
...
files.forEach(file => {
  ...
  // Find the block from <div className="flex-shrink-0 mr-4"> to the closing </div>
  const regex = /<div className="flex-shrink-0 mr-4">[\s\S]*?<\/div>/g;
  
  // Replace preserving indentation
  content = content.replace(regex, (match) => {
    return `<div className="flex-shrink-0 mr-4">\n${newSvg}\n</div>`;
  });
