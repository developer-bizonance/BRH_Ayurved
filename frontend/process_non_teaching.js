...
// 1. Parse HTML
const html = fs.readFileSync('non_teaching_staff_biometric.html', 'utf8');
...
// 3. Generate page.tsx
const pagePath = 'src/app/biometric-attendance/non-teaching-staff/page.tsx';
...
export default function NonTeachingStaffAttendancePage() {
  return (
    <div>
      <PageBanner title="Non Teaching Staff Biometric Attendance" breadcrumbs={[{ label: "Biometric Attendance" }, { label: "Non Teaching Staff" }]} />
