...
export const metadata = { title: "Fees Structure" };

const documents = [
  {
    "name": "ANNUAL FEES STRUCTURE - AY 2025-26",
    "url": "https://www.brharneayurved.in/uploads/fees_structure/fees_structure_20260507_085215.pdf"
  }
];
...
export default function FeesStructurePage() {
  return (
    <div>
      <PageBanner title="Fees Structure" breadcrumbs={[{ label: "Admissions" }, { label: "Fees Structure" }]} />
