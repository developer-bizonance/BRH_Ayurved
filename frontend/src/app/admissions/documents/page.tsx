...
export const metadata = { title: "List of Documents" };

const documents = [
  {
    "name": "List of Documents",
    "url": "https://www.brharneayurved.in/uploads/admission/list of documents.pdf"
  }
];

export default function ListofDocumentsPage() {
  return (
    <div>
      <PageBanner title="List of Documents" breadcrumbs={[{ label: "Admissions" }, { label: "List of Documents" }]} />
