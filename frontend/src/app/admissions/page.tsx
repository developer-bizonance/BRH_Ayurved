...
const admissionFiles = [
  {
    ...
    "url": "https://brharneayurved.in/assets/pdf/Admissions/Admission Details/Admission_Criteria.pdf"
  },
  {
    "name": "Fees Structure",
...
export default function AdmissionsPage() {
  return (
    <div>
      <PageBanner title="Admissions" breadcrumbs={[{ label: "Admissions" }]} />
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-0">
        <div className="w-full">
          <div className="flex flex-col gap-2">
            {admissionFiles.map((file, idx) => (
              <Link 
                href={file.url} 
                target="_blank"
                key={idx}
