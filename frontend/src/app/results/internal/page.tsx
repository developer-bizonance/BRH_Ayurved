...
export const metadata = { title: "Internal Assessment Result" };

const documents: any[] = []; // Empty array since the original page has no results published currently

export default function InternalAssessmentResultPage() {
  return (
    <div>
      <PageBanner title="Internal Assessment Result" breadcrumbs={[{ label: "Results" }, { label: "Internal Assessment Result" }]} />
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-0">

        {documents.length === 0 ? (
          <div className="bg-white rounded-2xl p-10 text-center shadow-sm border border-gray-100">
            <p className="text-gray-500">No results have been published for this section yet.</p>
          </div>
        ) : (
