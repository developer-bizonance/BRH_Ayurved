...
const documents = [
  {
    ...
    "url": "/uploads/hospital/Hospital Staff Details20250327_091839.pdf"
  },
  {
    "name": "Attendance - April 2025",
    "url": "/uploads/hospital/Attendance - April 202520250628_104411.pdf"
  },
  {
    "name": "Attendance - May 2025",
    "url": "/uploads/hospital/Attendance - May 202520250628_104455.pdf"
  }
];
...
export default function HospitalStaffPage() {
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-16 bg-transparent">
        {documents.length === 0 ? (
