...
export const metadata = { title: "Faculty Development Programme" };
...
export default function FacultyDevelopmentProgrammePage() {
  return (
    <div>
      <PageBanner title="Faculty Development Programme" breadcrumbs={[{ label: "About" }, { label: "Faculty Development Programme" }]} />
