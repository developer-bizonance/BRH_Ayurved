...
import ConductedEvents from "@/components/home/ConductedEvents";
...
export default async function HomePage() {
  ...
  try {
    ...
    notices = [
      { id: 1, title: "Prakriti Parikshan Report of CISF Unit JWC Mumbai", url: "#", isNew: true, date: "2025-03-25" },
      { id: 2, title: "Community Health Check up Camp", url: "#", isNew: true, date: "2025-03-31" },
      { id: 3, title: "Run For Ayurveda Students Prize Achievement", url: "#", isNew: true, date: "2026-02-14" },
      { id: 4, title: "Spandan 2026", url: "#", isNew: true, date: "2026-05-16" },
      { id: 5, title: "Summer Vacation 2026", url: "#", isNew: true, date: "2026-05-18" },
    ];
  }
