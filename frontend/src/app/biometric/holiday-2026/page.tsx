...
export const metadata = { title: "MUHS Holiday 2026" };

const documents = [
  {
    "name": "MUHS Holiday 2026",
    "url": "https://www.brharneayurved.in/uploads/biometric_attendance/MUHS Holiday 202620251216_062422.pdf"
  }
];

export default function MUHSHoliday2026Page() {
  return (
    <div>
      <PageBanner title="MUHS Holiday 2026" breadcrumbs={[{ label: "Biometric" }, { label: "MUHS Holiday 2026" }]} />
