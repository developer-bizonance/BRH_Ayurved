...
export const metadata = { title: "MUHS Mandate 2023-2024" };
...
export default function MUHSMandate20232024Page() {
  return (
    <div>
      <PageBanner title="MUHS Mandate 2023-2024" breadcrumbs={[{ label: "MUHS" }, { label: "MUHS Mandate 2023-2024" }]} />
