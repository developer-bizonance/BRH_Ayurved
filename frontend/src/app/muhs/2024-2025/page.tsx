...
export const metadata = { title: "MUHS Mandate 2024-2025" };
...
export default function MUHSMandate20242025Page() {
  return (
    <div>
      <PageBanner title="MUHS Mandate 2024-2025" breadcrumbs={[{ label: "MUHS" }, { label: "MUHS Mandate 2024-2025" }]} />
