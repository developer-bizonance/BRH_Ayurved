...
export const metadata = { title: "MUHS Mandate 2025-2026" };
...
export default function MUHSMandate20252026Page() {
  return (
    <div>
      <PageBanner title="MUHS Mandate 2025-2026" breadcrumbs={[{ label: "MUHS" }, { label: "MUHS Mandate 2025-2026" }]} />
