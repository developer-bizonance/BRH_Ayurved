...
export const metadata = { title: "MUHS Holidays" };

const files = [
  { "name": "MUHS Holiday 2025", "url": "https://brharneayurved.in/uploads/biometric_attendance/MUHS Holiday 202520250626_175530.pdf" },
  { "name": "MUHS Holiday 2026", "url": "https://brharneayurved.in/uploads/biometric_attendance/MUHS Holiday 202620251216_062422.pdf" }
];

export default function MUHSHolidaysPage() {
  return (
    <div>
      <PageBanner title="MUHS Holidays" breadcrumbs={[{ label: "Biometric Attendance" }, { label: "MUHS Holidays" }]} />
