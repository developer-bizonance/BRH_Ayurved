...
const files = [
  { name: "MUHS Holiday 2026", url: "/uploads/biometric_attendance/MUHS Holiday 202620251216_062422.pdf" }
];

export default function MUHSHoliday2026Page() {
  return (
    <div>
      <PageBanner title="MUHS Holiday 2026" breadcrumbs={[{ label: "Biometric Attendance" }, { label: "MUHS Holiday 2026" }]} />
